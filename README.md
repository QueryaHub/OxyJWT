...
This project is **beta** software on the `0.7.x` line; see the [changelog](CHANGELOG.md) for **0.2.0** breaking changes (exception hierarchy), **0.4.0** production-hardening, **0.6.0** security/JWKS hardening, and **0.7.0** performance notes.
